...
export const DORMS_DATA: Dormitory[] = [
  ...
  },
  {
    ...
    deposit: 550,
    roomTypes: ['Нэг хүний өрөө', 'Хоёр хүний өрөө'],
    features: ['Uni Wien төв кампус ба MedUni-тэй маш ойр', 'Чимээгүй сурах өрөөнүүд', 'Шууд U6 / 40, 41, 42 трамвай', 'Оюутны идэвхтэй уур амьсгал'],
    rating: 4.6,
    reviewsCount: 67,
    websiteUrl: 'https://www.home4students.at/',
    recommendedFor: 'Uni Wien болон Анагаахын оюутнуудад төгс байршил',
    badge: 'STUDENT HUB'
  },
  {
    id: 'the-social-hub-vienna',
    name: 'The Social Hub Vienna',
    provider: 'The Student Hotel',
    city: 'Wien',
    district: '2. Bezirk (Leopoldstadt)',
    address: 'Nordbahnstraße 47, 1020 Wien',
    pricePerMonth: 720,
    deposit: 750,
    roomTypes: ['Executive Studio', 'Standard King Studio'],
    features: ['Бүх өрөөнд унадаг дугуй үнэгүй дагалдана', 'Co-working space & Game lounge', 'Фитнесс, ресторан, арга хэмжээнүүд', 'U1/U2 Praterstern метро 5 мин'],
    rating: 4.9,
    reviewsCount: 88,
    websiteUrl: 'https://www.thesocialhub.co/vienna/',
    recommendedFor: 'Олон улсын оюутнууд, нетворкинг ба дээд зэрэглэлийн тав тух',
    badge: 'PREMIUM CO-LIVING'
  },
  {
    id: 'oead-graz-leechgasse',
    name: 'OeAD-Gästehaus Leechgasse',
    provider: 'OeAD',
    city: 'Graz',
    district: 'Geidorf',
    ...
    deposit: 500,
    roomTypes: ['Нэг хүний өрөө', 'Хоёр хүний өрөө'],
    features: ['Uni Graz их сургуулийн яг хажууд (2 мин)', 'Бүх хэрэглээ багтсан', 'Түүхэн үзэсгэлэнт ногоон бүс', 'Номын сан, спорт танхим'],
    rating: 4.8,
    reviewsCount: 39,
    websiteUrl: 'https://oeadstudenthousing.at/en/graz/',
    recommendedFor: 'Uni Graz болон TU Graz оюутнуудад'
  },
  {
    id: 'stuwo-linz',
    name: 'STUWO Student Residence Linz',
    provider: 'STUWO',
    city: 'Linz',
    district: 'Urfahr',
    address: 'Altenberger Straße 50, 4040 Linz',
    pricePerMonth: 430,
    deposit: 500,
    roomTypes: ['Нэг хүний өрөө', 'Хос апартмент'],
    features: ['JKU Linz кампусаас 300м', 'Саун, фитнесс, угаалгын газар', 'Орчин үеийн тавилга, интернэт', 'Унадаг дугуйн тусгай зогсоол'],
    rating: 4.7,
    reviewsCount: 34,
    websiteUrl: 'https://www.stuwo.at/en/dormitories/linz/',
    recommendedFor: 'JKU болон FH Upper Austria-ийн оюутнуудад'
  }
];
